...
if __name__ == '__main__':
    ...
    train_inputs, train_targets, epoch_size = get_lm_data_producer(train, train_config.batch_size, train_config.num_steps)
    valid_inputs, valid_targets, valid_epoch_size = \
        get_lm_data_producer(valid, train_config.batch_size, train_config.num_steps)
    test_inputs, test_targets, test_epoch_size = \
        get_lm_data_producer(test, 1, train_config.num_steps)
