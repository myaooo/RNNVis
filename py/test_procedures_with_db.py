...
if __name__ == '__main__':
    ...
    train_inputs, train_targets, epoch_size = get_lm_data_producer(datasets['train'], batch_size, num_steps)
    valid_inputs, valid_targets, valid_epoch_size = get_lm_data_producer(datasets['valid'], batch_size, num_steps)
    test_inputs, test_targets, test_epoch_size = get_lm_data_producer(datasets['test'], 1, 1)
